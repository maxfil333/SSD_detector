...
def create_data_lists(path, output_folder):
    ...
    # ------------------Training data------------------
    train_images, train_objects, n_objects = [], [], 0
    ...
    print(f'\nThere are {len(train_images)} training images '
          f'containing a total of {n_objects} objects. '
          f'Files have been saved to {os.path.abspath(output_folder)}.')

    # ------------------Test data------------------
    test_images, test_objects, n_objects = [], [], 0
    ...
    print(f'\nThere are {len(test_images)} test images '
          f'containing a total of {n_objects} objects. '
          f'Files have been saved to {os.path.abspath(output_folder)}.')
